...
class Res {
	 ...
	 */
	public function createTextmap(tileset:Tileset, character:String, ?firstTileIndex:Int = 0, ?paletteSample:PaletteSample, ?indecies:Array<Int>):Tilemap {
		if (paletteSample == null && indecies != null)
			paletteSample = createPaletteSample(indecies);
		return new Textmap(this, tileset, hTiles, vTiles, character, firstTileIndex);
	}
